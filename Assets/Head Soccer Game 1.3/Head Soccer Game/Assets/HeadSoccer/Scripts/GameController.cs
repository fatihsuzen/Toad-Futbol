...
public class GameController : MonoBehaviour {
	...
	public static int gameTime = 20;				//gameplay time for each round
	public int remainingTime;						//time left to finish the game
	...
	public bool gameFinishFlag = false;			//private flag
    ...
    public GameObject VideoAdsPlane;
	...
	void Awake () {
        gameTime = GameSystem.Instance.gameTime;
        ...
        GameSystem.Instance.adMobManager.adMobBanner.ShowBanner();
	}
    ...
    {
        if(GameSystem.Instance.showAdsCount >= GameSystem.Instance.showAdsCountMax)
        {
            if (GameSystem.Instance.adMobManager.adMobInterstitail.IsLoaded())
            {
                GameSystem.Instance.showAdsCount = 0;
                GameSystem.Instance.adMobManager.adMobInterstitail.ShowInterstitial();
            }
            else
            {
                GameSystem.Instance.adMobManager.adMobInterstitail.RequestInterstitial();
            }
        }
    }
