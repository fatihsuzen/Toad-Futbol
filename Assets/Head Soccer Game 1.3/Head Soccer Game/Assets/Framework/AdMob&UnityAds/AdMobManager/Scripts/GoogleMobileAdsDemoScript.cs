...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
...
#if UNITY_ANDROID
        string appId = "ca-app-pub-7897934482515571~3777616962";
#elif UNITY_IPHONE
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-7897934482515571/6212208611";
#elif UNITY_IPHONE
    ...
    private void RequestInterstitial()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-7897934482515571/6799845050";
#elif UNITY_IPHONE
    ...
    private void RequestRewardBasedVideo()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-7897934482515571/9055313936";
#elif UNITY_IPHONE
